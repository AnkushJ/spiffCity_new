<?php
  class Facebook_model extends CI_Model {
    public function __construct()
    {
        ...
        $params = array( 'next' => 'http://180.149.246.126/ankush/spiffCity' );
        $fb_data = array(
                        'me' => $profile,
                        'uid' => $user,
                        'loginUrl' => $this->facebook->getLoginUrl(
                            array(
                                ...
                                'redirect_uri' => 'http://180.149.246.126/ankush/spiffCity/popular' // URL where you want to redirect your users after a successful login
                            )
                        ),
