        ...
        <div id="container"><!--start_container-->
        	...
        	<div class="mid_contain"><!--start_mid_contain-->
                ...
                <div class="mid_contain_left"><!--start_mid_contain_left-->
                    ...
                    <h1>SafeDocManager keeps your documents in store for easy availability and accessibility. We ensure secured database for all your available documents. We store your</h1>
                    
                    <ul>
                    	<li>Personal Asset Information which includes all documents related to your personal information which could be Pancard, Passport, Marksheets, Licence and other Home Documents.</li>
                        <li>Mutual Fund Details with notifications on expiry and maturity as decided by you.</li>
                        <li>We emphasize upon easy portability and security of all your documents. Easy Access could be levied with emphasis on user comfort so that they could fill information both manually and digitally.</li>
                    </ul>
