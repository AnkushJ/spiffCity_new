        ...
        <div class="span9">
          <div class="modal-container">
            ...
            <div class="modal-body">
              <div class="image_box"> <img src="<?php echo base_url().'assets/img/crowdcast/'.$crowdcast_data[0]['img'];?>"></div>
            ...
            <div class="comments-block">
              <div class="row-fluid">
                <ul class="comment-ul">
                  ...
                  <li>
                    <div class="span2">
                      <div class="avt-box"><img src="<?php echo base_url(); ?>assets/img/avatar.jpg" alt="avataar_name"> </div>
                    </div>
                    <div class="span10">
              ...
              <div class="row-fluid ">
                <div class="add-commnet clearfix">
                  ...
                  <div class="span10">
                    <div class="commenterWrapper"> <a class="commnet_author_name" href="http://rosycontact.com/RickyG/"><?php echo ucFirst($this->session->userdata('firstname')); ?></a> <span class="commnet_time">Me</span> </div>
                    <p>
