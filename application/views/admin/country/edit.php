...
<article class="content-box minimizer">
	...
	echo form_open('admin/country/edit/'.$countryDetailsArr[0]['countryId'],$attributes);

	echo form_fieldset('Update Country');
	...
	$datacountryname = array(
		  ...
		  'value'		=> $countryDetailsArr[0]['countryName']
		);
	...
	echo form_submit('cmdSubmit', 'Update Country');
	echo form_close();
	?>
	</section>
</article>