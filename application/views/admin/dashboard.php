...
<ul class="shortcuts">
	...
	<li class="shortcut-cms"><a title="" href="<?php echo site_url("admin/coupons"); ?>">Coupons</a></li>
	<li class="shortcut-cms"><a title="" href="<?php echo site_url("admin/points"); ?>">Points</a></li>	<li class="shortcut-document"><a title="" href="<?php echo site_url("admin/category"); ?>">Document Category</a></li>
