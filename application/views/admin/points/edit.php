...
<article class="content-box minimizer">
	...
	$datapointsTitle = array(
		  ...
		  'value'		=> $pointsDetailsArr[0]['title'],
		);
	...
	$datapointsValue = array(
		  ...
		  'id'          => 'value',
		  'class'		=> 'small required',
		  'value'		=> $pointsDetailsArr[0]['value'],
		);
	...
	$datapointsSpiffPoints = array(
		  ...
		  'id'          => 'spiff_points',
		  'class'		=> 'small required',
		  'value'		=> $pointsDetailsArr[0]['spiff_points'],
		);
	
	$attributes = array('id' => 'frmPoints');
	$pointsId = $pointsDetailsArr[0]['id'];
	echo form_open_multipart('admin/points/edit/'.$pointsId,$attributes);
  ...
  <dl>
		...
		<dd>
			<?php echo form_textarea($datapointsSpiffPoints); ?>
		</dd>
		<dd >
          <span id="spanSpiffPoints" class="msg"><?php echo form_error('spiff_points'); ?></span>
    </dd>
	</dl>
